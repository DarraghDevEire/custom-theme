  ...
  for (const [src, contentPlacholders] of Object.entries(
    ...
    fetch(src)
      ...
      .then((syndicatedDOM) => {
        ...
        const syndicatedIcons = syndicatedDOM.getElementById('iconsMap')
        // Prevent the duplicate inclusion of SVG icons
        if (syndicatedIcons && !document.getElementById('iconsMap')) {
          document.body.append(syndicatedIcons)
        }
        syndicatedDOM.getElementById('iconsMap')?.remove()
